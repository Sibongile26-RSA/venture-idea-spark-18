  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        flicker: {
          "0%": { opacity: "1", textShadow: "0 0 10px hsl(var(--neon-cyan))" },
          "50%": { opacity: "0.8", textShadow: "0 0 15px hsl(var(--neon-magenta))" },
          "100%": { opacity: "1", textShadow: "0 0 20px hsl(var(--neon-lime))" },
        },
      },
      animation: {
