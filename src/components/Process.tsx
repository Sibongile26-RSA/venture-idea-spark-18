    ...
    <section className="py-20 bg-gradient-to-br from-slate-900 to-blue-900">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl font-inter font-light text-gray-300 max-w-3xl mx-auto">
                  ...
                  <CardContent className="p-6 text-center">
                    <div className="relative mb-6">
                      ...
                      <div className="absolute -top-2 -right-2 w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
                        <span className="text-white text-sm font-inter font-bold">{step.step}</span>
                      </div>
                    </div>
                    ...
                    <p className="text-gray-300 leading-relaxed text-sm font-inter font-light">
                      {step.description}
                    </p>
                  </CardContent>
                </Card>
        ...
        <div className="mt-16 bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
          <h3 className="text-2xl font-playfair font-bold text-white mb-4 text-center">Investment Criteria</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div>
              <h4 className="text-lg font-playfair font-semibold text-blue-400 mb-2">Investment Range</h4>
              <p className="text-gray-300 font-inter font-light">$10K - $3M</p>
            </div>
            <div>
              <h4 className="text-lg font-playfair font-semibold text-purple-400 mb-2">Stage Focus</h4>
              <p className="text-gray-300 font-inter font-light">Pre-Seed to Series A</p>
            </div>
            <div>
              <h4 className="text-lg font-playfair font-semibold text-indigo-400 mb-2">Sectors</h4>
              <p className="text-gray-300 font-inter font-light">EdTech, Healthcare, Tech & Innovation</p>
            </div>
          </div>
        </div>
      </div>
