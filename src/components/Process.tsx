...
const Process = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-deep-indigo to-vibrant-violet">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="relative">
          {/* Connection Line */}
          <div className="hidden lg:block absolute top-24 left-1/2 transform -translate-x-1/2 w-4/5 h-0.5 bg-gradient-to-r from-electric-teal to-bright-orange"></div>
                ...
                <Card className="bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2">
                  <CardContent className="p-6 text-center">
                    <div className="relative mb-6">
                      <div className="w-16 h-16 bg-gradient-to-br from-electric-teal to-bright-orange rounded-full flex items-center justify-center mx-auto mb-4">
                        <step.icon className="w-8 h-8 text-pure-white" />
                      </div>
                      <div className="absolute -top-2 -right-2 w-8 h-8 bg-gradient-to-br from-bright-orange to-vibrant-violet rounded-full flex items-center justify-center">
        ...
        <div className="mt-16 bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
          <h3 className="text-2xl font-bold text-pure-white mb-4 text-center">Investment Criteria</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div>
              <h4 className="text-lg font-semibold text-electric-teal mb-2">Investment Range</h4>
              <p className="text-gray-300">$10K - $3M</p>
            </div>
            <div>
              <h4 className="text-lg font-semibold text-bright-orange mb-2">Stage Focus</h4>
              <p className="text-gray-300">Pre-Seed to Series A</p>
            </div>
            <div>
              <h4 className="text-lg font-semibold text-vibrant-violet mb-2">Sectors</h4>
